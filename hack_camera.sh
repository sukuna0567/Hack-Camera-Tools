...
# Author     : ‎𝚵𝚳𝚸𝚵𝚪𝚯𝚪 𝐒𝐔𝐊𝐔𝚴𝚫 
# Github     : https://github.com/sukuna0567/Hack-Camera-Tools
# Clan YAMA Leader: +2250501889640
# Date       : 05-04-2025
# Portable File
# Contact IG: @j.m.h.2024 Follow
# Contact Telegram: @emperorsukuna
...
$red[Author]     ${cyan} :[EMPEROR SUKUNA]
$red[Github]     ${cyan} :[ https://github.com/sukuna0567/Hack-Camera-Tools] 
printf "${cyan}\Emperorsukuna${nc}@${cyan}SUKUNA ${red}$ ${nc}"
read about
